...
////import mapfre.paginas.PaginaBase;
//
//import java.io.File;
...
//			String reportPathLocal = System.getProperty("user.home")+"\\Documents\\"+datosConfig.getProperty("report")+"Reports.html"+"\\"+ PaginaBase.ProjectNameExtractor();
//
//
//			//Configuramos el ExtentSparkReporter
//			//Se filtra para la ejecución el local
//			if(datosConfig.getProperty("Local").equals("OK")){
//				PaginaBase.CrearDirectorio(reportPathLocal);
