...
public final class ProjectPaths {
	...
	public static String getDownloadPath() {
		...
		//milton: PaginaInicio.getidCasoPrueba() debera conectar con el nombre del test
		//Generate download Path.
//		return rootPath + datosConfig.getProperty("downloadPath") + PaginaInicio.getidCasoPrueba() + "\\";

		return rootPath + datosConfig.getProperty("downloadPath") + "CP00N" + "\\";
	}
